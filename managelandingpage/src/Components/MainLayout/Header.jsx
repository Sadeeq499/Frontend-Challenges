      ...
      <nav className="container relative mx-auto p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden">
            <div className="absolute flex flex-col hidden items-center self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md">
              <a className="hover:text-DarkGrayishBlue" href="#pricing">
                {" "}
                Pricing{" "}
              </a>
